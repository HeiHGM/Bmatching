...
class IlpExact : public AlgorithmImpl {
public:
  static constexpr absl::string_view AlgorithmName = "ilp_exact";
...
protected:
  absl::Status Execute(StandardIntegerHypergraph &hypergraph,
    ...
    HeiHGM::BMatching::bmatching::ilp::computeIlp(&hypergraph, bm, is_exact,
